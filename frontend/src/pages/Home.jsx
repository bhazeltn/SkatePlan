...
import { 
    ...
    ShieldCheck, ClipboardList, Settings, Plus, Users, User, Handshake, Eye
} from 'lucide-react';
        ...
        <div className="flex items-center gap-3">
          <Popover open={menuOpen} onOpenChange={setMenuOpen}>
            ...
            <PopoverContent align="end" className="w-56 p-2 flex flex-col gap-2 bg-white shadow-lg border rounded-md">
                 <AddSkaterModal onSkaterAdded={handleActionComplete} trigger={<Button variant="ghost" className="w-full justify-start h-10 font-normal"><User className="h-4 w-4 mr-2 text-gray-500" /> Athlete</Button>}/>
