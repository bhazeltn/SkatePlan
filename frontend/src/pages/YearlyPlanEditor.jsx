                ...
                <CardContent>
                    {goals.length === 0 ? (
                        ...
                        <div className="space-y-3">
                            {goals.map(goal => (
                                // Make entire card trigger the modal for view/edit
                                <GoalModal 
                                    key={goal.id}
                                    planId={planId} 
                                    goal={goal} 
                                    ...
                                    permissions={perms}
                                    trigger={
                                        <div className="flex items-start gap-3 p-3 border rounded-md hover:bg-slate-50 group bg-white cursor-pointer">
